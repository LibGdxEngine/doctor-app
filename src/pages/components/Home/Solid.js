...
function Solid() {
    return (
        <div className='w-full h-screen flex flex-col bg-orange-400 items-center px-8 md:px-36 py-36 md:py-24'>
            ...
            <div style={{"cursor": "pointer"}} className='w-full md:w-1/2 flex items-center justify-center bg-white  text-black font-bold py-4 px-4 rounded-lg mt-8 hover:bg-gray-200 transition duration-300'>
