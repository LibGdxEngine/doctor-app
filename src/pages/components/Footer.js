          ...
          <div className="text-center md:text-start flex flex-col items-center justify-center md:flex md:items-start md:justify-start">
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                ...
                <a href="tel:4915773733381" className="hover:text-orange-400 transition-colors">+49 1577 3733381</a>
              </li>
              <li className="flex items-center">
              ...
              <li className="flex items-center">
                <Image src={`/icons8-whatsapp (1).svg`} width={20} height={20} className="h-5 w-5 mr-3" />
